...
class Cust_OOBAnalyzer:
    def perform_analysis(self,tests, exec_data, road_length_before_oob=30, road_length_after_oob=30):
        ...
        for idx, tp in enumerate(tests):
            ...
            # Extract data about OOB, if any
            print("road data: {}".format(road_data))
            print("exec data: {}".format(execution_data))
            oob_pos, segment_before, segment_after, oob_side, oob_idx, execution_before = road_test_evaluation.identify_interesting_road_segments(road_data, execution_data)
