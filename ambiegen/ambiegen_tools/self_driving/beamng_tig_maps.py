...
class Maps:
    ...
    def __init__(self):
        ...
        #self.beamng_levels = LevelsFolder(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..')) + '/levels_template')
        self.source_levels = LevelsFolder(
            os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..')) + '/levels_template')  # os.getcwd()
