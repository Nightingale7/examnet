...
class MutatorNetwork(nn.Module):
    """Defines the neural network model for the test Mutator"""

    def __init__(self, input_shape, hidden_neurons, hidden_activation):
        super().__init__()
        ...
        # To generate a new test we take a sample test and mutate it.
        # Mutation is done by passing the test through neural network of dense layers 
        # As the learning efficiency and network capacity are dependent on the amount and size of dense layers, 
        # those are to be treated as hyperparameters and should be adjusted relative to the budget
